...
<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        ...
        <a href="MidEastShooting.php">Home</a>
...
<div id="WrapperFotos">
        <div class="row">
          ...
          if($resultaat)
          {
              while($data=mysqli_fetch_array($resultaat))
              {
                ...
                echo "<img src='../wapens/".$data['foto']."' onclick='openModal();currentSlide(1)' class='hover-shadow' alt='".$data['foto']."' style='width:100%'>";
                echo "</div>";
                if ($i==3) {
                  echo "</div>";
                  echo "<div class='row'>";
        ...
        <div class="row">
            ...
            <div class="column">
                <img src="../wapens/Magfoto.png" onclick="openModal();currentSlide(8)" class="hover-shadow" alt="five-seven" style="width:100%;">
            </div>
            <div class="column">
...
<div id="myModal" class="modal">
  ...
  while($data=mysqli_fetch_array($resultaat))
  {
    ...
    echo "<div class='numbertext'>".$i." / 9</div>";
    echo "<img src='../wapens/".$data['fotoinfo']."' style='width:100%'>";
    echo "</div>";
  }
  ?>
<!--<div class="mySlides">
